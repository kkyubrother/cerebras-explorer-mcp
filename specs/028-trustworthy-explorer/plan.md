...
| Extra model passes increase latency | Cost/latency are observable, not acceptance gates; allow one initial plan/audit, at most one corrected plan/audit, one semantic verification, and at most one repair/reverification cycle. Each verifier pass may submit at most one bounded late-goal audit batch, never a new planner or repair loop. |
