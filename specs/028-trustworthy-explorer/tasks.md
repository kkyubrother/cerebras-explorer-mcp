...
- [x] T069 Run live `scripts/integration-test.mjs` and `scripts/run-trust-suite.mjs` with `CEREBRAS_API_KEY`, `LOG_PATH`, and an external logical repo map as specified in `specs/028-trustworthy-explorer/quickstart.md`; do not commit local absolute paths or transcripts
