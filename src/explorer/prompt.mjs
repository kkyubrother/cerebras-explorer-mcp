...
export function buildExplorerSystemPrompt({ repoRoot, budgetConfig, language, projectContext, previousSummaries, keyFiles }) {
  const parts = [
    ...
    '  "targets": [{"path": "relative/path", "startLine": 1, "endLine": 10, "role": "read|edit|reference", "reason": "...", "evidenceRefs": []}],',
...
export function buildFinalizePrompt() {
  return [
    ...
    '  • Optional runtime-facing fields may be included when obvious: directAnswer, targets[], uncertainties[], nextAction, status',
