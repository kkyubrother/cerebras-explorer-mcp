...
export function buildFreeExploreSystemPrompt({ repoRoot, budgetConfig, language, projectContext, previousSummaries, keyFiles }) {
  const parts = [
    ...
    '- If you see "[summarized]" or "[truncated]" markers, some content was omitted to fit the context window; do not assume it was preserved. If expected evidence seems missing, re-read a narrower line range or re-run a narrower query.',
