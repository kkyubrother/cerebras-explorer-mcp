...
const CANONICAL_DECOMPOSITION_PATTERNS = Object.freeze([
  ...
  '- If the caller explicitly requests an exact unaffected or no-modification proof, keep that request-derived absence obligation separate from the bounded wrapper:map_change_impact:risk_boundary leaf. Never merge the negative proof into the fixed risk leaf or weaken it into remaining uncertainty.',
